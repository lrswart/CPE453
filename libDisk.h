#ifndef __DISK_EMULATOR_H__
#define __DISK_EMULATOR_H__

/**
 *  * This function opens a regular UNIX file and designates the first nBytes of it
 *   * as space for the emulated disk. nBytes should be an integral number of the
 ...
 *       * integrity of any file content beyond nBytes. The return value is -1 on
 *        * failure or a disk number on success.
 *         */
int openDisk(char* filename, int nBytes);
int closeDisk(int disk);

/**
 *  * This function reads an entire block of BLOCKSIZE bytes from the open disk
...
/**
 *  * This function takes disk number ‘disk’ and logical block number ‘bNum’ and
 ...
 *       * been opened) or any other failures. You must define your own error code
 *        * system.
 *         */
int writeBlock(int disk, int bNum, void* block);

#endif /* __DISK_EMULATOR_H__ */
